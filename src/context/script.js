...
async function getData(){
    ...
    profile_pic_url = "https://ddragon.leagueoflegends.com/cdn/14.2.1/img/profileicon/"+profile_pic_number+".png";
    
    // Ranked
    var summoner_id = dataSummoner_full.id
    var summonerNameUrl2 = "/lol/league/v4/entries/by-summoner/";
    var ranked_summoner_url = na_url+summonerNameUrl2+summoner_id+"?api_key="+API_key;
    ...
    try {
        ...
        soloRankData = rankedSummoner_data.tier + " " + rankedSummoner_data.rank + " " + lp + " LP";
